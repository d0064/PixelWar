...
In order to avoid any future confusion or discussion about it, the founder of PixelWar took an active stance, considered multiple options and created this document.

This CoC is derived from the [SQLite Code of Ethics](https://sqlite.org/codeofethics.html).

## Our Pledge

The founder of PixelWar, and developers at the time when this document was derived (21.07.2023), have pledged to try to govern their interactions with each other, with their clients, and with the larger PixelWar user community in accordance with the “Tools of good works” from chapter 4 of [The Rule of St. Benedict](https://theruleofbenedict.com/) (hereafter: **“The Rule“**). They view *The Rule* as their promise to all PixelWar users of how the developers are expected to behave. This is a one-way promise, or covenant. In other words, the developers are saying: “We will treat you this way regardless of how you treat us.”
...
No one is required to follow *The Rule*, to know *The Rule*, or even to think that *The Rule* is a good idea. The Founder of PixelWar believes that anyone who follows *The Rule* will live a happier and more productive life, but individuals are free to dispute or ignore that advice if they wish.
